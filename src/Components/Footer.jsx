...
function Footer() {
  ...
  return (
    <div className="w-full bg-white border-t border-white text-green-600 lg:px-16 md:px-8 px-4 py-6">
      <div className="grid lg:grid-cols-4 grid-cols-1 md:grid-cols-2   mt-6 py-12">
        <div>
          <h1 className="text-green-600 text-2xl mt-8 lg:mt-0 md:mt-0 mb-8">Our Office</h1>
          <p className="text-green-600 my-4 w-3/4">
            25 Babatunde Jose Road, Victoria Island, Lagos +234 909 6996 102,
            +234 909 6996 104
          </p>
          <p className="text-green-600 my-4 w-3/4">info@ndwestern.com</p>
        </div>
        <div>
          ...
          <ul className="grid grid-cols-1">
            ...
            <Link to={"/about/life_at_NDWestern"} className="mb-4">
              News and Lifestyle
            </Link>
        ...
        <div className="w-full lg:mt-0 md:mt-12 mt-12">
          ...
          <div className="flex mt-2">
            <a href="https://twitter.com/ndwestern">
              <svg
                className="mx-2"
                width={38}
                height={38}
